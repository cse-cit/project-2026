           ...
           with st.spinner('Deep Scanning classroom photos..'):
              ...
              if not enrolled_students:
                st.warning(
                    ...
                    st.session_state.logs = attendance_to_log
...
def teacher_screen_login():
    ...
    teacher_username = st.text_input("Enter username", placeholder='Janvi Singh')
...
def teacher_screen_register():
    ...
    teacher_username = st.text_input("Enter username", placeholder='Janvi_Singh123')
    
    teacher_name = st.text_input("Enter Name", placeholder='Janvi Singh')
